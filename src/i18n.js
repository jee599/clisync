const messages = {
  ko: {
    initTitle: "GitHub 인증",
    initOauth: "브라우저에서 아래 주소를 열고 코드를 입력하세요:",
    initCode: "코드:",
    initWaiting: "브라우저에서 인증 대기 중...",
    initTokenFallback: "토큰으로 직접 로그인하려면:",
  ...
  en: {
    initTitle: "GitHub Authentication",
    initOauth: "Open this URL in your browser and enter the code:",
    initCode: "Code:",
    initWaiting: "Waiting for browser authorization...",
    initTokenFallback: "To log in with a token instead:",
    tokenPrompt: "  GitHub token: ",
